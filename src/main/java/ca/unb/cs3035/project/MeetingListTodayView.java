...
public class MeetingListTodayView extends Pane {
    public MeetingListTodayView() {
        Main.meetingListModel.todaysMeetingListProperty().addListener(new ListChangeListener<MeetingWidget>() {
            @Override
    ...
    public void displayList() throws IOException {
        ...
        for(MeetingWidget m: Main.meetingListModel.todaysMeetingListProperty) {
