...
public class TaskListTodayView extends Pane {
    public TaskListTodayView() {
        Main.taskListModel.todaysTaskListProperty().addListener(new ListChangeListener<TaskWidget>() {
            @Override
    ...
    public void displayList() throws IOException {
        ...
        for(TaskWidget t: Main.taskListModel.todaysTaskListProperty) {
